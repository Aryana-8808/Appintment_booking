...
<html lang="en">
    <head>
        ...
        <style>
            ...
            .card-body {
              padding: 3rem 4rem; /* More spacious padding */
            }
        
            h4.text-center {
              margin-bottom: 2rem; /* Space after heading */
            }
        
            .form-floating .form-label {
              color: #888; /* Lighter label color */
            }
        
            .form-control:focus {
              border-color: lightblue; /* Green border on focus */
              box-shadow: 0 0 0.25rem lightblue; /* Green outline on focus */
            }
            ...
            .btn-primary:hover {
              background-color: #f5a081; /* Darker green on hover */
              border-color: #f5a081; /* Darker green border on hover */
            }
                                ...
                                <div class="row">
                                    <div class="col-12">
                                        ...
                                        <div class="d-flex gap-2 gap-md-4 flex-column flex-md-row justify-content-center">
                                            <a href="{{route('account.register')}}" class="link-secondary text-decoration-none text-center">Create new account</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
